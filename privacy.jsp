        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>About Us</h3>
                    <p class="lead">I at ResumeATS, have developed a web-based application for shortening the interview selection process to a bit of extent. This Project does not totally fulfills each and every requirement however it will surely be helpful for users in the future.</p>
                </div>
            </div><!-- end title -->
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
