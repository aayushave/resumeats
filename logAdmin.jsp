...
<html>
	...
	<body><!-- values given at login page are taken here and checks if the valid details are not -->
		<%
            ...
            String sql="select userid,company,first_name,last_name,email,pass,dob,phonenumber from dbadmin where email=?";
			...
			session.setAttribute("email",email);
                        ...
                        response.sendRedirect("admin/index.jsp"); //AND WE REDIRECTED TO LOGIN PAGE
                       
                   
                   }else
                {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Invalid password Credentials');");
                out.println("location='admin.html';");
                out.println("</script>");
                }  
            }else{out.println("<script type=\"text/javascript\">");
                out.println("alert('Invalid rs error Credentials');");
                out.println("location='admin.html';");
                out.println("</script>");
                    }}        
