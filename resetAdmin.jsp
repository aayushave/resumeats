...
<%
    ...
    String sql="select company,first_name,email,pass from dbadmin where email='"+to+"' AND first_name='"+first_name+ "' AND company='"+company+"' ";
        ...
        String messg="Dear " +f_name + ", At "+compny+", <br />Your password for 'Resume ATS' is : </h3><strong> "+pwd+" </strong>";
